                    ...
                    <div class="art-content">
                        ...
                        <div class="art-Post-inner">
                            ...
                            <div class="art-PostContent">
                                <applet
        code = "middlewar.client.Main"
        codebase="."
        archive= "http://localhost/MiddleWarClient/dist/MiddleWarClient.jar,
                  http://localhost/MiddleWarCommon/dist/MiddleWarCommon.jar,
                  http://localhost/MiddleWarXMWP/dist/MiddleWarXMWP.jar"
        width = "416"
        height="496">
        <param name="key" value="unknown"/>
        </applet>
                        ...
                        <div class="art-Post-inner">
                            <h2 class="art-PostHeaderIcon-wrapper">
                                <span class="art-PostHeader">Who uses our products?</span>
                            </h2>
                            <div class="art-PostContent">
