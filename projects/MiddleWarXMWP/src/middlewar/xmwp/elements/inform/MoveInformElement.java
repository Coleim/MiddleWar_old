 ...
 * @author higurashi
 */
public class MoveInformElement extends Element{
    ...
    public MoveInformElement() throws XMWPException {
        super(ElementType.move, "onReceivedInformMove");
    }

    public MoveInformElement(String id,String map,int x,int y) throws XMWPException {
        super(ElementType.move, "onReceivedInformMove");
        this.id = id;
        this.x = x;
        this.y = y;
